...
ois.tr <- ois.traits[, c(
  "Espece",
  "Taxonomy.English.Name..BirdLife...IOC...Clements.AviList.",
  "Primary.Diet"
)]
...
ridg1 <- ois4 %>%
  ...
  scale_colour_manual(
    values = c(inferno(10)[2], inferno(10)[4], inferno(10)[6], inferno(10)[9]),
    labels = c("carnivore", "Invertebrate", "Omnivore", "Seed")
  ) +
  scale_fill_manual(
    values = c(inferno(10)[2], inferno(10)[4], inferno(10)[6], inferno(10)[9]),
    labels = c("carnivore", "Invertebrate", "Omnivore", "Seed")
...
ggsave("outputs/birds-ridge-plot-all-species.png",
       width = 7,
       height = 15)
...
ggsave(
  "outputs/birds-ridge-plot-15-most-common-species.png",
  width = 7,
  height = 15
)
...
ggsave(
  "outputs/birds-ridge-plot-common-species.png",
  width = 7,
  height = 15
)
...
ggsave(
  "outputs/carabid-ridge-plot-common-species.png",
  width = 7,
  height = 15
)
...
ggsave(
  "outputs/saprox-deciduous-species-ridge-plot.png",
  width = 7,
  height = 15
)
...
ggsave(
  "outputs/saprox-conifer-species-ridge-plot.png",
  width = 7,
  height = 15
)
...
ggsave(
  "outputs/saprox-generalist-species-ridge-plot.png",
  width = 7,
  height = 15
)
